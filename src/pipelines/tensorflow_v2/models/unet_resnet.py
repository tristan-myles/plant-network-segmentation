...
class ResBlock(tf.keras.Model):
    def __init__(self, channels, initializer, activation, stride=1,
                 decode=False):
        super().__init__()
...
class UnetResnet(tf.keras.Model, _TfPnsMixin):
    def __init__(self, output_channels, activation="relu",
        ...
        self.down_block_3_1 = ResBlock(16 * 2**filters, stride=2,
                                       activation=activation,
                                       initializer=initializer)
        self.down_block_3_2 = ResBlock(16 * 2**filters, activation=activation,
                                       initializer=initializer)
        self.down_block_3_3 = ResBlock(16 * 2**filters, activation=activation,
                                       initializer=initializer)
        self.down_block_3_4 = ResBlock(16 * 2**filters, activation=activation,
                                       initializer=initializer)

        self.down_block_4_1 = ResBlock(32 * 2**filters, stride=2,
                                       activation=activation,
                                       initializer=initializer)
        self.down_block_4_2 = ResBlock(32 * 2**filters, activation=activation,
                                       initializer=initializer)
        self.down_block_4_3 = ResBlock(32 * 2**filters, activation=activation,
                                       initializer=initializer)
        self.down_block_4_4 = ResBlock(32 * 2**filters, activation=activation,
                                       initializer=initializer)
        self.down_block_4_5 = ResBlock(32 * 2**filters, activation=activation,
                                       initializer=initializer)
        self.down_block_4_6 = ResBlock(32 * 2**filters, activation=activation,
                                       initializer=initializer)

        self.down_block_5_1 = ResBlock(64 * 2**filters, stride=2,
                                       activation=activation,
                                       initializer=initializer)
        self.down_block_5_2 = ResBlock(64 * 2**filters, activation=activation,
                                       initializer=initializer)
        self.down_block_5_3 = ResBlock(64 * 2**filters, activation=activation,
                                       initializer=initializer)

        self.conv_up1 = Conv2DTranspose(filters=32 * 2**filters, kernel_size=2,
        ...
        # Layer 2
        self.conv_up2 = Conv2DTranspose(filters=16 * 2**filters, kernel_size=2,
                                        strides=2, activation=activation,
                                        kernel_initializer=initializer)
        ...
        # Layer 3
        self.conv_up3 = Conv2DTranspose(filters=8 * 2**filters, kernel_size=2,
                                        strides=2, activation=activation,
                                        kernel_initializer=initializer)
        ...
        # Layer 4
        self.conv_up4 = Conv2DTranspose(filters=8 * 2**filters, kernel_size=2,
                                        strides=2, activation=activation,
                                        kernel_initializer=initializer)
